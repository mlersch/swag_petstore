...
[![Build Status](https://travis-ci.org/mlersch/swag_petstore.svg?branch=master)](https://travis-ci.org/mlersch/swag_petstore)
...
6. If you did everything correct, https://mlersch.github.io/swag_petstore/ will lead to your new docs
...
- Documentation(ReDoc): https://mlersch.github.io/swag_petstore/
- SwaggerUI: https://mlersch.github.io/swag_petstore/swagger-ui/
- Look full spec:
    + JSON https://mlersch.github.io/swag_petstore/swagger.json
    + YAML https://mlersch.github.io/swag_petstore/swagger.yaml
- Preview spec version for branch `[branch]`: https://mlersch.github.io/swag_petstore/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://mlersch.github.io/swag_petstore/ with url from the message: `Server started <url>`
